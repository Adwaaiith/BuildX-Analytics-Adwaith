...
1. Which IPL team has scored the highest total runs across all seasons?
2. How are boundary (4s and 6s) and non-boundary deliveries distributed?
3. How has the total number of runs changed across different IPL seasons?

## Tools Used

* Python (Pandas) – Data cleaning and preprocessing
* SQLiteOnline – SQL business analysis
